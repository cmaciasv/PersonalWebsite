    ...
    <main className="flex-grow flex flex-col items-center justify-center text-center px-4 sm:px-6 lg:px-8 py-8">
      <div className="animate-fade-in-up space-y-4">
        ...
        <div className="max-w-3xl mx-auto text-lg md:text-xl space-y-4">
          ...
          <h2 className="text-4xl tracking-tighter mt-8 --foreground">
            Skills
          </h2>
          <ul className="list-disc text-left mx-auto max-w-2xl space-y-1 md:text-lg text-gray-600 dark:text-gray-400">
